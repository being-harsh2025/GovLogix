      ...
      <section style={{ marginTop: "30px", padding: "20px", background: "#f0f0f0", borderRadius: "8px" }}>
        ...
        <ul>
          <li>
            ...
            <br />
            <small>Value: libsql://govlogix-harshxrtx.aws-ap-south-1.turso.io</small>
          </li>
          <li>
        ...
        <ol>
          ...
          <li>Select your <strong>gov-logix</strong> project</li>
        ...
        <p>Should return: <code>{"{status: 'ok', database: 'connected'}"}</code></p>
      </section>

      <section style={{ marginTop: "30px", padding: "20px", background: "#fff3cd", borderRadius: "8px", borderLeft: "4px solid #ffc107" }}>
        <h3>⚠️ Common Issues:</h3>
        <ul>
          <li>❌ Variables not added → Go to Vercel Settings → Environment Variables</li>
          <li>❌ Added but not redeployed → Click Redeploy after adding variables</li>
          <li>❌ Wrong scope → Make sure "Production" scope is selected</li>
          <li>❌ Typo in variable names → Must be exactly: TURSO_DATABASE_URL and TURSO_AUTH_TOKEN</li>
        </ul>
      </section>

      <section style={{ marginTop: "30px", padding: "20px", background: "#d4edda", borderRadius: "8px", borderLeft: "4px solid #28a745" }}>
